	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			if (serverSocket.isBound()) {
				...
				ProtocolHeader responseHeader = StreamingMusicProtocol.receiveHeader(client);
				String requestMessage = StreamingMusicProtocol.receiveString(client, responseHeader.payloadLength);

				StreamingMusicProtocol.sendHeader(client, MessageType.RESPONSE, (int)soundFile.length());
